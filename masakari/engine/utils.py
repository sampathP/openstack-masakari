...
from masakari.engine.db.models import NotificationList, VmList
...
class RecoveryControllerUtilDb(object):
    ...
    def insert_notification_list_db(self, jsonData, recover_by, session):
        ...
        try:
            ...
            LOG.error(self.rc_util.msg_with_thread_id(e.message))
...
class RecoveryControllerUtilApi(object):
    ...
    def do_instance_stop(self, uuid):
        ...
        try:
            ...
            LOG.error(self.rc_util.msg_with_thread_id(msg + error_msg))
